...
describe('timer reducer', () => {
  ...
  it('should be able to update the number of seconds left', () => {
    ...
    const actual = timer({ ...expected, secondsLeft: 156 }, timerTick(expected.secondsLeft));
  ...
  it('should not be possible to set a duration longer than one hour', () => {
    ...
    const actual = [timer({ duration: 59, secondsLeft: 0, secondsPerMinute: 60 }, incrementDuration())];
  ...
  it('should not be possible to set a duration shorter than one minute', () => {
    ...
    const actual = [timer({ duration: 2, secondsLeft: 0, secondsPerMinute: 60 }, decrementDuration())];
