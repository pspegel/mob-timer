...
export const shortenDuration = createStandardAction('mob-timer/SHORTEN_DURATION')<void>();
export const extendDuration = createStandardAction('mob-timer/EXTEND_DURATION')<void>();
...
export type ManualUpdateNavigatorsAction = ActionType<typeof manualUpdateNavigators>;

export const incrementDuration = createStandardAction('mob-timer/INCREMENT_DURATION')<void>();
export const decrementDuration = createStandardAction('mob-timer/DECREMENT_DURATION')<void>();
