...
import { manualNextDriver, manualNextNavigator, manualSwitchDriverAndNavigator, timerStart } from '../actions';
...
const CurrentRoles: React.FunctionComponent<{}> = () => {
  ...
  const swapRoles = React.useCallback(() => dispatch(manualSwitchDriverAndNavigator()), [dispatch]);
  ...
  return (
    <div className="current-roles inner-wrap">
      ...
      <div className="button-wrap">
        <button type="button" onClick={startTimer} disabled={!isValid} className="go-button">
          Go!
        </button>
